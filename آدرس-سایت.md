...
<a dir="rtl" target="_blank" href="https://kimianets.ir/index.php#plans" rel="dofollow" dir="rtl" align="right"> ☑️ https://kimianets.ir/index.php#plans </a>
<br> &nbsp;&nbsp;&nbsp; ⥣ &nbsp;&nbsp;&nbsp; ⥣ &nbsp;&nbsp;&nbsp; ⥣ &nbsp;&nbsp;&nbsp; ⥣ &nbsp;&nbsp;&nbsp; ⥣ &nbsp;&nbsp;&nbsp; ⥣ &nbsp;&nbsp;&nbsp; ⥣  </h1>

<hr>

<h2> 💛 چت آنلاین <h6> پشتیبانان ما در کمتر از 1 دقیقه پاسخگوی شما هستند </h6> 
<a dir="rtl" target="_blank" href="https://kimianets.ir/pay/direct.php?card=1&qty=1" rel="dofollow" target="_blank" dir="rtl" align="right"> ☑️ کلیک جهت چت آنلاین </a></h3>

 <hr>

<h2> 🤍 آی دی تلگرام  <h6> جهت خرید سریع و راهنمایی در مراحل خرید</h6>
<a dir="rtl" href="tg://resolve?domain=online_support724&text=سلام_جهت_خرید_اکانت_پیام_میدهم" target="_blank"> ☑️ @online_support724 </a></h3>
<br><br>


<br> <br> <br> <br> <br> <br>
<center><a><img src="hub.gif" width="30%" align="center"></a></center>
...
<script>
    ...
    $('#submit').on('click', function () {
        ...
        // business logic...
        //$.wait( function(){ $btn.button('reset') }, 8);
    })
    ...
    <script>
window.chatwootSettings = {"position":"right","type":"standard","launcherTitle":"گفتگو"};
      (function(d,t) {
        var BASE_URL="https://chat.cpanel98.ir";
        ...
        g.onload=function(){
          window.chatwootSDK.run({
            websiteToken: 'tHHgyPrXXa9yCVNvzZEe92JE',
            baseUrl: BASE_URL
          })
        }
      })(document,"script");
